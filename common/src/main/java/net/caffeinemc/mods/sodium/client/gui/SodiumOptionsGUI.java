...
public class SodiumOptionsGUI extends Screen implements ScreenPromptable {
    ...
    static {
        DONATION_PROMPT_MESSAGE = List.of(
                ...
                FormattedText.composite(Component.literal("It seems that you've been enjoying "), Component.literal("Sodium").setStyle(Style.EMPTY.withColor(TextColor.fromRgb(0x27eb92))), Component.literal(", the free and open-source optimization mod for Minecraft.")),
                FormattedText.composite(Component.literal("Mods like these are complex. They require "), Component.literal("thousands of hours").setStyle(Style.EMPTY.withColor(TextColor.fromRgb(0xff6e00))), Component.literal(" of development, debugging, and tuning to create the experience that players have come to expect.")),
                FormattedText.composite(Component.literal("If you'd like to show your token of appreciation, and support the development of our mod in the process, then consider "), Component.literal("buying us a coffee").setStyle(Style.EMPTY.withColor(TextColor.fromRgb(0xed49ce))), Component.literal(".")),
