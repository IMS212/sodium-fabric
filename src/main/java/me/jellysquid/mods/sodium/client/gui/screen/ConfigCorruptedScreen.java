...
public class ConfigCorruptedScreen extends Screen {
    ...
    public void render(DrawContext matrices, int mouseX, int mouseY, float delta) {
        ...
        matrices.drawTextWithShadow(this.textRenderer, Text.literal("Sodium Renderer"), 32, 32, 0xffffff);
        matrices.drawTextWithShadow(this.textRenderer, Text.literal("Could not load configuration file"), 32, 48, 0xff0000);
        ...
        for (int i = 0; i < TEXT_BODY.size(); i++) {
            ...
            matrices.drawTextWithShadow(this.textRenderer, TEXT_BODY.get(i), 32, 68 + (i * 12), 0xffffff);
        }
    }
}
