...
public interface CloudVertexSink extends VertexSink {
    VertexFormat VERTEX_FORMAT = VertexFormats.POSITION_TEXTURE_COLOR_NORMAL;
     ...
     */
    void writeQuad(float x, float y, float z, int color, float u, float v, int normal);
     ...
     */
    default void writeQuad(MatrixStack.Entry matrices, float x, float y, float z, int color, float u, float v, int normal) {
        ...
        this.writeQuad(x2, y2, z2, color, u, v, norm);
    }
}
