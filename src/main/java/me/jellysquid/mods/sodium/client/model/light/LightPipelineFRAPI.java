 ...
 * and block entities. 
 */
public interface LightPipelineFRAPI {
    /**
     ...
     */
    void calculate(QuadViewImpl quad, BlockPos pos, QuadLightData out, Direction cullFace, Direction lightFace, boolean shade);
}
