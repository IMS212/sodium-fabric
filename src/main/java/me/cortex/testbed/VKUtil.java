...
import static me.cortex.testbed.IOUtils.ioResourceToByteBuffer;
...
public class VKUtil {
    ...
    public static ByteBuffer glslToSpirv(String classPath, int vulkanStage) throws IOException {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            res = shaderc_compile_into_spv(compiler, src, vulkanStageToShadercKind(vulkanStage), stack.UTF8("shader"), stack.UTF8("main"), options);
            if (res == 0L)
