...
public class DescriptorUpdateBuilder {
    ...
    private static void bufferPrep(MemoryStack stack, VkWriteDescriptorSet writer) {
        writer.descriptorCount(1).pBufferInfo(VkDescriptorBufferInfo.calloc(1, stack)).descriptorType(VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER);
    }
    ...
    public DescriptorUpdateBuilder buffer(int binding, VVkBuffer[] buffers) {
        updates.add(new Pair<>(DescriptorUpdateBuilder::bufferPrep,
            (index, writer) -> {
    ...
    public DescriptorUpdateBuilder buffer(int binding, VVkBuffer buffer) {
        updates.add(new Pair<>(DescriptorUpdateBuilder::bufferPrep,
                (index, writer) -> {
