...
public class VVkExportedAllocator extends VVkAllocator {
    ...
    public VVkExportedAllocator(VVkDevice device) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            handleTypes.put(0, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT);//VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT
            handleTypes.put(1, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT);//VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT
            handleTypes.put(2, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT);//VK_MEMORY_PROPERTY_HOST_COHERENT_BIT
            handleTypes.put(3, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT);//VK_MEMORY_PROPERTY_HOST_CACHED_BIT
            handleTypes.put(4, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT);//VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT
